...
function paintInsightContents() {
    for (let i = 0; i < careerInsights.imgs.length; i++) {
        ...
        <li class="section-contents__li">
            <a href="#">
                <div class="section-contents__thumb"><img src=${careerInsights.imgs[i]}" alt="콘텐츠 썸네일"></div>
                <div class="section-contents__title">${careerInsights.titles[i]}</div>
                <div class="section-contents__desc">${careerInsights.descs[i]}</div>
                <div class="section-contents__writer">
                    <button class="section-contents__writer__button"><img src=${careerInsights.icons[i]}" alt="유튜브 버튼"></button>
                    <span class="section-contents__writer__title">${careerInsights.writers[i]}</span>
                </div>
            </a>
        </li>
        `
        $sectionContentsUl.insertAdjacentHTML('beforeend', $li);
    }

    // careerInsights.forEach(item => {
    //     console.log('item :>> ', item);
        // const $li = document.createElement('li');
        // const $a = document.createAttribute('a');

        // const $divThumb = document.createElement('div');
        // $divThumb.classList.add('section-contents__thumb');
        // const $divThumbImg = document.createElement('img');
        // $divThumbImg.src = item.imgs;
        // $divThumb.appendChild($divThumbImg);

        // const $divTitle = document.createElement('div');
        // $divTitle.innerText = item.titles;

        // const $divDesc = document.createElement('div');
        // $divDesc.innerText = item.descs;

        // const $divWriter = document.createElement('div');
        // const $btnWriter = document.createElement('button');
        // $btnWriter.classList.add('section-contents__writer__button')
        // $divDesc.innerText = item.descs;
