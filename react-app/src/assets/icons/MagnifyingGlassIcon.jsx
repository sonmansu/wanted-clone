  ...
  return (
    ...
    >
      ...
      <g fill="none" fill-rule="evenodd">
        <mask id="jobsfeed_shortcut_search_b" fill="#FFFFFF">
          <use xlink:href="#jobsfeed_shortcut_search_a" fill="#FFFFFF"></use>
        </mask>
        <use
          fill="none"
          fill-rule="nonzero"
          xlink:href="#jobsfeed_shortcut_search_b"
        ></use>
        <g mask="url(#jobsfeed_shortcut_search_b)" fill="#FFFFFF">
          <path d="M0 0h28v28H0z" fill="#FFFFFF"></path>
        </g>
      </g>
    </svg>
  );
