        ...
        <footer class="footer">
            <div class="footer-wrap">
                <div class="footer-top">
                    <img class="footer-top__logo"
                        src="https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fuserweb%2Flogo_wanted_black.png&w=110&q=100"
                        alt="wanted 로고" />
                    <nav class="footer-top__nav">
                        <ul class="footer-top__nav__ul">
                            <li><a href="#">기업소개</a></li>
                            <li><a href="#">이용약관</a></li>
                ...
                <div class="footer-bottom">
                    ...
                    <div class="footer-bottom-country-box">
                        <div class="footer-bottom__country">
                            <img src="https://static.wanted.co.kr/images/userweb/ico_KR.svg" alt=""
                                class="footer-bottom__country__country-icon" />
                            <select class="footer-bottom__country__select" name="" id="">
                                <option value="KR">한국 (한국어)</option>
                                <option value="JP">日本 (日本語)</option>
                                <option value="WW">Worldwide (English)</option>
                                <option value="SG">Singapore (English)</option>
                            </select>
                            <img class="footer-bottom__country__down-icon"
